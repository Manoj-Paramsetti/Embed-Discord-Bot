...
def welcome_msg():
    ...
    embed.add_field(name = "Check the syntax to send the message", value="[syntax](https://github.com/Manoj-Paramsetti/Embed-Discord-Bot/wiki)", inline = False)
    ...
    embed.set_footer(text="Enjoy with embed message ❤️ ", icon_url="https://i.pinimg.com/originals/1c/54/f7/1c54f7b06d7723c21afc5035bf88a5ef.png")
